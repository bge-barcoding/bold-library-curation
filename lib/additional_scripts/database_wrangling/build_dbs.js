...
function initDatabaseAndLoadData(xmlPath, database) {
    return new Promise((resolve, reject) => {
        fs.readFile(xmlPath, 'utf8', async (readErr, xmlData) => {
            ...
            const columns = [
                'url','ranking','BAGS','status','recordid','taxonid','processid','sampleid','fieldid',
                ...
                'associated_specimens','associated_taxa','collection_date_start', 'collection_date_end',
                ...
                'sampling_protocol','nuc_basecount','insdc_acs','funding_src','marker_code','sequence_run_site','sequence_upload_date',
                'recordset_code_arr','extrainfo','country','collection_note','associated_specimen','gb_acs','nucraw','curator_notes','collectors', 'additionalStatus'
            ];
